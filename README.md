...
Các bộ gõ tiếng Việt hiện tại trên macOS đang gặp nhiều vấn đề:
- ⚠️ **Lag và giật** khi gõ, ảnh hưởng trải nghiệm người dùng
- 🚫 **Không tương thích** với các phiên bản macOS mới (Ventura, Sonoma, Sequoia)
- 🐛 **Nhiều bug** chưa được sửa, ít được tác giả cập nhật và bảo trì
- 🔧 **Thiếu tính năng** hiện đại và tùy biến linh hoạt

**XKey** được tạo ra để giải quyết triệt để những vấn đề trên!

### ✨ Điểm nổi bật

- ⚡ **Hiệu suất vượt trội**: Viết hoàn toàn bằng **Swift native**, tối ưu hóa tối đa cho macOS, không lag, phản hồi tức thì
- 🎯 **Tương thích hoàn hảo**: Chạy mượt mà trên tất cả phiên bản macOS 12.0+ (Monterey, Ventura, Sonoma, Sequoia)
...
1. Tải file `.dmg` hoặc `.app` mới nhất từ [Releases](https://github.com/xmannv/xkey/releases)
2. Mở file `.dmg` và kéo XKey vào thư mục Applications
